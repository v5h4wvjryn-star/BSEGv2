            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    <p className="text-lg text-gray-600 leading-relaxed">
                        {/* Superseded marketing copy removed. This file is retained only for
                            the careers/admin components below; see README.md in this folder. */}
    ...
    const portfolioCompanies = [
        {
            ...
            isHiring: hiringStatus["Placeholder Company A"]
        },
        {
            ...
            isHiring: hiringStatus["Placeholder Company B"]
        },
        {
            name: "Placeholder Company C",
            description: "Placeholder description. Original entity descriptions were removed — see README.md in this folder.",
            icon: <Shield className="w-10 h-10 text-white" />,
            type: "Ground-Up Venture",
            url: "https://jovial-manatee-38798e.netlify.app/#services",
            isHiring: hiringStatus["Placeholder Company C"]
        },
        {
            name: "Placeholder Company D",
            description: "Placeholder description. Original entity descriptions were removed — see README.md in this folder.",
            icon: <Briefcase className="w-10 h-10 text-white" />,
            type: "Ground-Up Venture",
            url: null,
            isHiring: hiringStatus["Placeholder Company D"]
        },
    ];
...
const CareersSection = ({ id, onNavigate }) => {
    ...
    const portfolioCompanies = [
        "All Companies", "Placeholder Company A", "Placeholder Company B",
        "Placeholder Company C", "Placeholder Company D"
    ];
...
const PrivateJobPost = ({ id }) => {
    ...
    const [jobData, setJobData] = useState({ title: '', company: 'Placeholder Company A', location: '', description: '' });
    ...
    const portfolioCompanies = [
        "Placeholder Company A", "Placeholder Company B",
        "Placeholder Company C", "Placeholder Company D"
    ];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setJobData({ title: '', company: 'Placeholder Company A', location: '', description: '' }); // Reset form
        } catch (error) {
        ...
        <section id={id} className="py-24 bg-white text-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-4">
                    We welcome inquiries regarding acquisitions, partnerships, and commercial real estate opportunities.
                </p>
